...
export const WSOLA_PROCESSOR_NAME = 'cyc-wsola';

export const WSOLA_WORKLET_JS = `
var wsolaStretch = (${wsolaStretch.toString()});
...
registerProcessor('${WSOLA_PROCESSOR_NAME}', CycWsola);
`;
